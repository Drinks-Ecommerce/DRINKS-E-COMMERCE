    ...
    <header className=" bg-gray-800 text-gray-100">
      <div className="flex justify-between h-16 mx-5">
        ...
        <div className="flex items-center md:space-x-4">
          <div className="relative">
            ...
            <input
              ...
              name="Search"
              placeholder="Search..."
              className="w-32 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none bg-gray-700 text-gray-100 focus:bg-gray-900"
            />
          </div>
        </div>
        ...
        <div className="flex items-center md:space-x-2 mx-0">
          <button
            type="button"
            className="hidden px-6 py-2 font-semibold rounded md:block bg-teal-400 text-gray-600"
          >
            Registrar
          </button>
          <button
      ...
      <div class="flex justify-center bg-black pb-3 pt-3 mt-2">
        <ul class="flex">
          <li class="mr-4">
            <option
              value="vino"
              className="text-white text-lg font-bold hover:text-blue-500 cursor-pointer"
          ...
          <li class="mr-4">
            <option
              value="whisky"
              class="text-white text-lg font-bold hover:text-blue-500 cursor-pointer"
              onClick={(e) => handleFilterByType(e)}
            >
              WHISKYS
            </option>
          ...
          <li class="mr-4">
            <option
              class="text-white text-lg font-bold hover:text-blue-800"
              onClick={(e) => handleFilterByType(e)}
            >
              ESPUMANTES
            </option>
