    ...
    return(
        <div className="flex flex-col mt-5 items-center rounded-lg shadow-md mx-auto bg-white w-60 ">
            ...
            <div className='flex flex-col mx-2 mt-5'>
                ...
                <a className="text-white mt-3 mb-2 bg-teal-600 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                onClick={handleClick}>AÑADIR AL CARRITO</a>
            </div>
            </div>
        </div>
